...
namespace MaterialUI
{
    ...
    public class MaterialSwitch : ToggleBase
    {
        ...
        public override void TurnOnInstant()
        {
            ...
            switchRectTransform.anchoredPosition = new Vector2(m_OffsetX, 0f);
        }
        ...
        public override void AnimOn()
        {
            ...
            switchRectTransform.anchoredPosition = Tween.SeptSoftOut(new Vector2(m_CurrentSwitchPosition, 0f), new Vector2(m_OffsetX, 0f), m_AnimDeltaTime, m_AnimationDuration);
        }
