    ...
    public class DialogManager : MonoBehaviour
    {
        ...
        private void InitDialogSystem()
        {
            ...
            if (m_ParentCanvas == null)
            {
                ...
                m_ParentCanvas = MaterialUIManager.UIRoot.GetRootCanvas();
            }
        ...
        /// <returns></returns>
        public static DialogBottomList ShowBottomList(string[] options, Action<int> onItemClick)
        {
            ...
            DialogBottomList dialog = PrefabManager.InstantiateGameObject(PrefabManager.ResourcePrefabs.dialogBottomList, instance.transform).GetComponent<DialogBottomList>();
            dialog.Initialize(optionDataList, onItemClick);
            dialog.Show();
            return dialog;
        }
