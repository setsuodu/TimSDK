...
public class FlowLayoutGroup : LayoutGroup
{
    ...
    protected Vector2 m_CellSize = new Vector2(25, 25);
    ...
    public override void CalculateLayoutInputVertical()
    {
        ...
        {
            preferred = Mathf.Abs(rectChildren[0].anchoredPosition3D.y - rectChildren[rectChildren.Count - 1].anchoredPosition3D.y) + padding.top + padding.bottom + cellSize.y;
        }
        //Debug.Log(preferred);

        SetLayoutInputForAxis(minSpace, preferred, -1, 1);
    }
